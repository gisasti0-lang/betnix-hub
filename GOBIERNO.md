...
| 3 | **Baneo de la cuenta de Telegram** | Telegram detecta patrón de automatización sobre una sesión de usuario | Se pierde la cuenta con la que se gestionan 211 afiliados | El sistema solo lee; no hay envío automático, que es lo que dispara la detección. Antecedente real: el número de WhatsApp de MJ Empresa se bloqueó por esto mismo |
...
| 5 | **Corrupción del Excel por escritura concurrente** | El agente escribe mientras el archivo está abierto en Excel | Se pierden las columnas de seguimiento de los 211 contactos | La escritura ocurre a las 08:00, fuera del horario de uso. Reconstruible desde `corridas/*/salida.json` |
